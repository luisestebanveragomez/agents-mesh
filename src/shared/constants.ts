...
export const DATA_DIR = process.env.AGENTS_MESH_DATA ?? join(homedir(), ".agents-mesh-data");
...
export const POLL_MS        = Number(process.env.AGENTS_MESH_POLL_MS)        || 2_000;
export const HEARTBEAT_MS   = Number(process.env.AGENTS_MESH_HEARTBEAT_MS)   || 15_000;
export const TTL_S          = Number(process.env.AGENTS_MESH_TTL_S)          || 120;
export const DASHBOARD_PORT = Number(process.env.AGENTS_MESH_DASHBOARD_PORT) || 5723;
